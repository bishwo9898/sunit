...
export default function AdminPortraitsGallery() {
        ...
        <header className="mb-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-400 mt-1">
              Read-only preview of category “portraits”.
            </p>
          </div>
          <div className="ml-auto flex items-center gap-3">
            ...
            >
              <span className="text-[12px]">Delete from Portraits</span>
            </button>
          </div>
        </header>
        <UploadBox
